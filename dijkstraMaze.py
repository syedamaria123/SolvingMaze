...
if __name__=='__main__':
    ...
    h1=agent(myMaze,4,9,color=COLOR.red)
    h2=agent(myMaze,3,6,color=COLOR.red)
    h3=agent(myMaze,5,1,color=COLOR.red)
    h4=agent(myMaze,9,2,color=COLOR.red)
    h5=agent(myMaze,4,3,color=COLOR.red)
    h6=agent(myMaze,8,7,color=COLOR.red)
    h7=agent(myMaze,4,5,color=COLOR.red)
    h8=agent(myMaze,10,7,color=COLOR.red)
    ...
    # path,c=dijstra(myMaze,h1,h2,h2,h3,h4,h5,h6,h7,h8)
    path,c=dijkstra(myMaze,h1,h2,h3,h4,h5,h6,h7,h8,start=(6,1))
